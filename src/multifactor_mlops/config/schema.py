...
class LabelConfig(BaseModel):
    ...
    decision_to_execution_bars: int = 1
    holding_bars: int = 1
...
class ValidationConfig(BaseModel):
    model_config = ConfigDict(extra="ignore")
    split_mode: str = "train_test_split_2024"
...
class PortfolioConfig(BaseModel):
    ...
    inverse_vol_period: int = 60
    stress_vix_threshold: float = 22.0
    stress_fng_threshold: float = 30.0
    stress_dvol_threshold: float = 65.0
